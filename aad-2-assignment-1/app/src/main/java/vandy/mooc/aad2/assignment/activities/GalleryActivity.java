...
public class GalleryActivity
    ...
    public static Intent makeStartIntent(
        ...
        Log.i("tage", "begin makeStartIntent");
        ...
        // TODO - you fill in here.
        newIntent.putParcelableArrayListExtra("Uri Data", inputUrls);

        // Return the intent.
        // TODO - you fill in here replacing null with the appropriate value.
        Log.i("tage", "end makeStartIntent");
        return newIntent;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // do that for you.
        Log.i("tage", "start gallery onCreate");
    ...
    private List<Uri> extractInputUrlsFromIntent(Intent intent) {
        ...
        Log.i("tage", "begin gallery extractInputUrlsfromintent");

        List<Uri> uriList = intent.getParcelableArrayListExtra("Uri Data");
        if (!validateInput(intent.getParcelableArrayListExtra("Uri Data")))
            return null;

        Log.i("tage", "end gallery extractInputUrlsfromintent");
        return uriList;
    }
    ...
    private boolean validateInput(ArrayList<Uri> inputUrls) {
        ...
        Log.i("tage", "begin gallery validateinput");
        if (inputUrls == null) {
            ...
            for (Uri uriElement : inputUrls)
            {
                if (!UriUtils.isValidUrl(uriElement.toString())) {
                    Log.i("tage", "bad url: " + uriElement.toString());
                    return false;
                }
            }

        }
        Log.i("tage", "end gallery validateinput");
        return true;
    }
