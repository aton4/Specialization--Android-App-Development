...
public class DownloadAtomFeedService extends IntentService {
    ...
    public static Intent makeIntent(Context context, int requestCode, Uri url) {
        ...
        Intent newIntent = new Intent(context, DownloadAtomFeedService.class).setData(url).putExtra("Request Code", requestCode);
        return newIntent;
    }
    ...
    public void onHandleIntent(Intent intent) {
        ...
        // TODO - you fill in here.
        List<Entry> listEntries = this.downloadAtomFeed(url);
        ...
        // TODO - you fill in here.
        this.sendEntries((ArrayList<Entry>)listEntries,intent.getData(),MainActivity.RESULT_OK);
    }
    ...
    private Bundle makeReplyBundle(ArrayList<Entry> entries,
        ...
        // TODO - you fill in here
        data.putParcelableArrayList("Entries", entries);
